#!/usr/bin/env python3
"""
Recuperation des codes promo Columbia depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/columbiasportswear.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/columbiasportswear.fr"
STORE_NAME = "Columbia"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Columbia depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-columbiasportswear)"
    }
    try:
